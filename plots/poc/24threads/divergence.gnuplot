...
set style line 1 lc rgb "#00A000" pt 9
set style line 2 lc rgb "#5060D0" pt 5
set style line 3 lc rgb "#F25900" pt 18
...
set xlabel "{/*1.3 increments}"
set ylabel "{/*1.3 time s}"

set key right bottom

set xtics (2000000, 4000000, 6000000, 8000000, 10000000, 15000000, 20000000)
#set xtic auto
set xrange [*:*]    
set yrange [*:*]
